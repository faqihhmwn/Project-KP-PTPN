...
class LaporanKonsultasiKlinikExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithStyles
{
    protected $unitId;
    protected $bulan;
    protected $tahun;
    ...
    public function query()
    {
        $query = LaporanBulanan::query()
            ...
            ->where('kategori_id', 5); // Filter hanya untuk kategori Kependudukan
