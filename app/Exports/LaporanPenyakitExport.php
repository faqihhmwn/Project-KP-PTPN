...
class LaporanPenyakitExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithStyles
{
    protected $unitId;
    protected $bulan;
    protected $tahun;
    ...
    {
        // Ganti KATEGORI_ID menjadi 2 untuk Penyakit
        $query = LaporanBulanan::query()
            ->with(['unit', 'subkategori'])
            ->where('kategori_id', 2); // ID 2 untuk Kategori Penyakit
