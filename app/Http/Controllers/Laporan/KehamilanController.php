...
use App\Exports\LaporanKehamilanExport;
...
class KehamilanController extends Controller
{
    ...
    {       
        ...
        $fileName = 'laporan_kehamilan_' . date('Y-m-d_H-i-s') . '.xlsx';

        return Excel::download(new LaporanKehamilanExport($unitId, $bulan, $tahun, $subkategoriId), $fileName);
    }
}