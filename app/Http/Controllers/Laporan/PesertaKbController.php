...
use App\Exports\LaporanPesertaKbExport;
...
class PesertaKbController extends Controller
{
    ...
    {       
        ...
        $fileName = 'laporan_peserta_kb_' . date('Y-m-d_H-i-s') . '.xlsx';

        return Excel::download(new LaporanPesertaKbExport($unitId, $bulan, $tahun, $subkategoriId), $fileName);
    }
}