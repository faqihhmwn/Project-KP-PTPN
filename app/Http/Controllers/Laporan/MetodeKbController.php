...
use App\Exports\LaporanMetodeKbExport;
...
class MetodeKbController extends Controller
{
    ...
    {       
        ...
        $fileName = 'laporan_metode_kb_' . date('Y-m-d_H-i-s') . '.xlsx';

        return Excel::download(new LaporanMetodeKbExport($unitId, $bulan, $tahun, $subkategoriId), $fileName);
    }
}