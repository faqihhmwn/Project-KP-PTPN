...
use App\Exports\LaporanSakitBerkepanjanganExport;
...
class SakitBerkepanjanganController extends Controller
{
    ...
    {       
        ...
        $fileName = 'laporan_sakit_berkepanjangan_' . date('Y-m-d_H-i-s') . '.xlsx';

        return Excel::download(new LaporanSakitBerkepanjanganExport($unitId, $bulan, $tahun, $subkategoriId), $fileName);
    }
}