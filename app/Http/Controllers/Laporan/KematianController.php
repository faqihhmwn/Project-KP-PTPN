...
use App\Exports\LaporanKematianExport;
...
class KematianController extends Controller
{
    ...
    {       
        ...
        $fileName = 'laporan_kematian_' . date('Y-m-d_H-i-s') . '.xlsx';

        return Excel::download(new LaporanKematianExport($unitId, $bulan, $tahun, $subkategoriId), $fileName);
    }
}