                        ...
                        <div class="row g-2">
                            <div class="col-md-2">
                                <a href="{{ route('admin.obat.index') }}"
                                    class="btn btn-info w-100 mb-2 d-flex flex-column align-items-center justify-content-center">
                                    <i class="bi bi-list-ul mb-1" style="font-size: 1.5rem;"></i>
                                    Daftar Obat
                                </a>
                            </div>
                            <div class="col-md-2">
                                <a href="{{ route('admin.obat.rekapitulasi') }}"
                                    class="btn btn-warning w-100 mb-2 d-flex flex-column align-items-center justify-content-center">
                                    <i class="bi bi-bar-chart-line mb-1" style="font-size: 1.5rem;"></i>
                                    Rekapitulasi
                                </a>
                            </div>
                            <div class="col-md-2">
                                <a href="{{ route('admin.obat.analisis.obat') }}"
                                    class="btn btn-success w-100 mb-2 d-flex flex-column align-items-center justify-content-center">
