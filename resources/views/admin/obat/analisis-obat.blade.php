...
@section('content')
    <div class="container">
        ...
        <form method="GET" action="{{ route('admin.obat.analisis.obat') }}" class="row g-3 mb-4">
            <div class="col-md-3">
            ...
            <div class="col-md-12 d-flex justify-content-between">
                ...
                {{-- <a href="{{ route('admin.obat.analisis.obat.export', request()->all()) }}" class="btn btn-success">Export</a> --}}
            </div>
        </form>

        <form action="{{ route('admin.obat.analisis.obat.export') }}" method="GET" class="d-inline">
