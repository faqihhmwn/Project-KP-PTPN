    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('laporan.kependudukan.store') }}">
                @csrf
                {{-- Dropdown Bulan dan Tahun sekarang di luar fieldset --}}
                <div class="row mb-3">
                    <div class="col-md-3">
                ...
                {{-- Fieldset ini yang akan di-disable, membiarkan dropdown di atas tetap aktif --}}
                <fieldset id="input-form-content">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>@foreach ($subkategori as $sub)<tr><td>{{ $sub->nama }}</td><td><input type="number" name="jumlah[{{ $sub->id }}]" class="form-control" min="0" value="" placeholder="Masukkan jumlah"></td></tr>@endforeach</tbody>
                    </table>
